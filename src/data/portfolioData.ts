  ...
  capabilities: [
    {
      ...
      tagline: "Concevoir des produits numériques complets, des exigences à la mise en production.",
      description: "Approche globale alliant compréhension métier, expérience utilisateur et rigueur technique pour concevoir des logiciels à fort impact mesurable.",
      technologies: ["Cadrage Produit", "Prototypage Système", "Parcours Utilisateurs", "Mise en Production"],
      keyOutputs: ["Spécifications Produit", "Exécution MVP", "Bases Scalables"],
      icon: "Boxes"
    },
    {
      ...
      tagline: "Interfaces modernes, réactives, accessibles et rigoureusement typées.",
      description: "Développement d'applications web et mobiles résilientes avec TypeScript strict, design systems modulaires et architecture de composants moderne.",
      technologies: ["Angular", "Next.js", "Ionic", "Tailwind CSS", "TypeScript", "Systèmes UI Modernes"],
      keyOutputs: ["Design Systems", "Dashboards Temps Réel", "PWAs Offline-Ready"],
      icon: "Layout"
    },
    {
      id: "backend-apis",
      number: "03",
      title: "Backend & APIs",
      tagline: "Microservices robustes, APIs RESTful et logique métier sécurisée.",
      description: "Conception de services backend tolérants aux pannes, architecture orientée domaine, autorisations granulaires et requêtes optimisées.",
      technologies: ["FastAPI", "Python", "Symfony", "Node.js", "Express", "APIs REST", "OAuth2/JWT"],
      keyOutputs: ["APIs Haute Performance", "Moteurs de Règles Métier", "Authentification Sécurisée"],
      icon: "Server"
    },
    {
      ...
      tagline: "Persistance fiable, conteneurisation et déploiement cloud maîtrisé.",
      description: "Conception de schémas relationnels normalisés et de bases documentaires haute cadence avec pipelines de déploiement Dockerisés.",
      technologies: ["PostgreSQL", "MariaDB", "MongoDB", "SQLite", "Docker", "Docker Compose", "Déploiement Cloud"],
      keyOutputs: ["Schémas Normalisés", "Environnements Docker", "Pipelines CI/CD"],
      icon: "Database"
    },
    {
      ...
      tagline: "Modèles de Machine Learning appliqués directement aux produits en production.",
      description: "Développement de pipelines prédictifs de bout en bout, moteurs de classification supervisée et intégration d'outils d'aide à la décision.",
      technologies: ["Scikit-learn", "Random Forest", "SVM", "XGBoost", "Pipelines Prédictifs", "Fonctionnalités IA"],
      keyOutputs: ["Modèles ML Cliniques", "APIs d'Inférence", "Aide à la Décision"],
      icon: "Brain"
    },
    {
      ...
      tagline: "Systèmes Offline-First, synchronisation distribuée et patterns orientés événements.",
      description: "Architecture de systèmes distribués résilients gérant les coupures réseau, la synchronisation bidirectionnelle et la cohérence des données.",
      technologies: ["Systèmes Offline-First", "Architecture Distribuée", "Microservices", "Event-Driven", "Synchronisation de Données"],
      keyOutputs: ["Résolution de Conflits", "Persistance Edge", "Topologies Événementielles"],
      icon: "Cpu"
    }
  ],
  featuredProjects: [
  ...
  capabilities: [
    {
      ...
      number: "01",
      title: "Product Engineering",
      tagline: "Designing complete digital products from requirements to production-ready systems.",
      description: "Holistic approach bridging business goals, user experience, and technical execution to build software that creates measurable value.",
      technologies: ["Requirements Scoping", "System Prototyping", "User Journey Mapping", "Production Release"],
      keyOutputs: ["Product Specs", "MVP Execution", "Scalable Foundations"],
      icon: "Boxes"
    },
    {
      id: "frontend-engineering",
      number: "02",
      title: "Frontend Engineering",
      tagline: "High-performance, accessible, and type-safe user interfaces.",
      description: "Building responsive, resilient web and mobile applications with strict TypeScript standards, design tokens, and modular UI architectures.",
      technologies: ["Angular", "Next.js", "Ionic", "Tailwind CSS", "TypeScript", "Modern UI Systems"],
      keyOutputs: ["Design Systems", "Real-Time Dashboards", "Offline-Ready PWAs"],
      icon: "Layout"
    },
    {
      id: "backend-apis",
      number: "03",
      title: "Backend & APIs",
      tagline: "Robust microservices, clean RESTful architectures, and secure business logic.",
      description: "Engineering fault-tolerant backend services with clean domain-driven architecture, granular authorization, and optimal query throughput.",
      technologies: ["FastAPI", "Python", "Symfony", "Node.js", "Express", "REST APIs", "OAuth2/JWT"],
      keyOutputs: ["High-Throughput APIs", "Business Logic Engines", "Secure Auth Systems"],
      icon: "Server"
    },
    {
      id: "data-infrastructure",
      ...
      tagline: "Reliable data persistence, containerized environments, and cloud deployment.",
      description: "Designing normalized relational schemas and high-throughput document stores with automated Dockerized deployment pipelines.",
      technologies: ["PostgreSQL", "MariaDB", "MongoDB", "SQLite", "Docker", "Docker Compose", "Cloud Deployment"],
      keyOutputs: ["Normalized DB Schemas", "Containerized Environments", "CI/CD Workflows"],
      icon: "Database"
    },
    {
      id: "artificial-intelligence",
      ...
      tagline: "Practical machine learning models integrated directly into production software.",
      description: "Developing end-to-end predictive pipelines, classification engines, and integrating AI capabilities into decision support tools.",
      technologies: ["Scikit-learn", "Random Forest", "SVM", "XGBoost", "Predictive Pipelines", "AI Features"],
      keyOutputs: ["Clinical ML Models", "Prediction APIs", "Automated Decision Support"],
      icon: "Brain"
    },
    {
      id: "software-architecture",
      ...
      tagline: "Offline-first systems, distributed sync, and event-driven patterns.",
      description: "Architecting resilient distributed systems that handle network partitions gracefully, synchronize seamlessly, and maintain data consistency.",
      technologies: ["Offline-first Systems", "Distributed Architecture", "Microservices", "Event-Driven Systems", "Data Sync"],
      keyOutputs: ["Conflict Resolution", "Edge Persistence", "Distributed Event Topologies"],
      icon: "Cpu"
    }
  ],
  featuredProjects: [
